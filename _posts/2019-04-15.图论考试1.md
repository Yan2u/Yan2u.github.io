...
>  <font size=6>**做题心得**</font>

只背模板题的解法是不行的，实际考试中可能要求对模板题解法进行改写，使其符合题目要求，能得出正确答案，就连建图，有时候也不是题目就明确告诉了的，需要根据自己对题目的理解建出合适的图，然后用合适的算法求解答案。

对于题目复杂条件的拆分也是解题的关键，在 P3 里如果坚持要根据题目所给的 N 个点来求最短路的话，会使得代码复杂度大大提高，还可能导致 SPFA 死循环，但是当题目条件被拆分之后，我们发现黑洞白洞之间的联系明显比以前更容易建立了，只是多耗费了 N 个点的空间，却能让这个题更高效简洁的被解答。
